...
//	, pt.post_description
//-- modify	
	$sql = "SELECT u.username, u.user_id, p.*,  pt.post_text, pt.post_subject, pt.post_description, pt.bbcode_uid
...
//-- mod : post description ----------------------------------------------------
//-- add
			$post_description = ( $row['post_description'] != '' ) ? $row['post_description'] : '';
//-- fin mod : post description ------------------------------------------------			
