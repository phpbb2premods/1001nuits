...
//	, &$flag
//-- modify
function display_avatar_gallery($mode, &$category, &$user_id, &$email, &$current_email, &$coppa, &$username, &$email, &$new_password, &$cur_password, &$password_confirm, &$icq, &$aim, &$msn, &$skype, &$yim, &$website, &$location, &$occupation, &$interests, &$flag, &$bday_date, &$browser, &$signature, &$viewemail, &$notifypm, &$popup_pm, &$notifyreply, &$attachsig, &$allowhtml, &$allowbbcode, &$allowsmilies, &$user_absent, &$hideonline, &$style, &$language, &$timezone, &$dateformat, &$session_id, &$user_qp_settings, &$gender)
//-- fin mod : birthday --------------------------------------------------------
...
//	, 'flag'
//-- modify
	$params = array('coppa', 'user_id', 'username', 'email', 'current_email', 'cur_password', 'new_password', 'password_confirm', 'icq', 'aim', 'msn', 'skype', 'yim', 'website', 'location', 'occupation', 'interests', 'flag', 'bday_day', 'bday_month', 'bday_year', 'browser', 'signature', 'viewemail', 'notifypm', 'popup_pm', 'notifyreply', 'attachsig', 'allowhtml', 'allowbbcode', 'allowsmilies', 'user_absent', 'hideonline', 'style', 'language', 'timezone', 'dateformat', 'user_qp', 'user_qp_show', 'user_qp_subject', 'user_qp_bbcode', 'user_qp_smilies', 'user_qp_more', 'gender');
//-- fin mod : birthday --------------------------------------------------------
//-- fin mod : browsers list ---------------------------------------------------
//-- fin mod : quick post es ---------------------------------------------------
//-- fin mod : flags -----------------------------------------------------------
