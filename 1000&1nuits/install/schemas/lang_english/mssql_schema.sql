/*
 ...
 $Id: mssql_schema.sql,v 1.1.2.12 2006/02/06 21:32:42 grahamje Exp $
...
CREATE TABLE [phpbb_ctracker_ipblocker] (
	[id] [mediumint] (8) unsigned NOT NULL auto_increment=33,
...
CREATE TABLE [phpbb_rcs] (
	[rcs_id] [int] IDENTITY UNSIGNED NOT NULL auto_increment,
	[rcs_name] [varchar] (50) DEFAULT '' NOT NULL,
	[rcs_color] [varchar] (6) DEFAULT '' NOT NULL,
	[rcs_single] [tinyint] NOT NULL,
	[rcs_display] [tinyint] NOT NULL,
	[rcs_order] [meduimint] UNSIGNED NOT NULL,
) ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_title_infos] (
  ...
  [title_pos] [TINYINT] NOT NULL DEFAULT '0',
  [admin_auth] [TINYINT] DEFAULT '0',
  [mod_auth] [TINYINT] DEFAULT '0',
  [poster_auth] [TINYINT] DEFAULT '0'
) ON [PRIMARY];
GO
...
ALTER TABLE [phpbb_bbc_box] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_bbc_box] PRIMARY KEY  CLUSTERED
	(
		[bbc_id]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_ctracker_config] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_ctracker_config] PRIMARY KEY  CLUSTERED
	(
		[ct_config_name]
	)  ON [PRIMARY]
GO

ALTER TABLE [phpbb_ctracker_ipblocker] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_ctracker_ipblocker] PRIMARY KEY  CLUSTERED
	(
		[id]
	)  ON [PRIMARY]
GO

ALTER TABLE [phpbb_captcha_config] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_captcha_config] PRIMARY KEY  CLUSTERED
	(
		[config_name]
	)  ON [PRIMARY]
GO

ALTER TABLE [phpbb_guests_visit] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_guests_visit] PRIMARY KEY  CLUSTERED
	(
		[guest_time]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_shout] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_shout] PRIMARY KEY  CLUSTERED
	(
		[shout_id]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_title_infos] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_title_infos] PRIMARY KEY  CLUSTERED
	(
		[id]
	)  ON [PRIMARY]
GO
...
ALTER TABLE [phpbb_bbc_box] WITH NOCHECK ADD
	CONSTRAINT [DF_phpbb_bbc_box_bbc_order] DEFAULT (1) FOR [bbc_order],
GO
...
ALTER TABLE [phpbb_rcs] WITH NOCHECK ADD 
	CONSTRAINT [DF_phpbb_rcs_rcs_name] DEFAULT ('') FOR [rcs_name]
	CONSTRAINT [DF_phpbb_rcs_rcs_color] DEFAULT ('') FOR [rcs_color]
	CONSTRAINT [DF_phpbb_rcs_rcs_single] DEFAULT (0) FOR [rcs_single]
	CONSTRAINT [DF_phpbb_rcs_rcs_display] DEFAULT (0) FOR [rcs_display]
GO
