 ...
 * version		: 2.3.2 - 31/03/2005 00:39
 *
 * $Id		: miniprofile.php, v 2.3.2 - 31/03/2005 00:39 - crewstyle Exp $
 *
 ***************************************************************************/
...
switch ( $profiledata['user_level'] )
{
	case ADMIN:
		...
		$profiledata['username'] = '<span ' . $style_color . '>' . $profiledata['username'] . '</span>';
		break;
	case MOD:
