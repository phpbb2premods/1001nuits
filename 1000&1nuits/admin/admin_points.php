...
$sql = "SELECT *
	FROM " . CONFIG_TABLE . "
	WHERE config_name IN('allow_point_system', 'points_reply', 'points_topic', 'points_post', 'points_poll', 'points_vote', 'points_browse', 'points_page', 'points_donate', 'points_name', 'points_user_group_auth_ids')";
if (!$result = $db->sql_query($sql))
{
...
$allow_point_system_yes = ( $new['allow_point_system'] ) ? "checked=\"checked\"" : "";
$allow_point_system_no = ( !$new['allow_point_system'] ) ? "checked=\"checked\"" : "";
...
$template->assign_vars(array(
	...
	"L_POINT_SYSTEM" => $lang['Point_System'],
	"POINT_SYSTEM_YES" => $allow_point_system_yes,
	"POINT_SYSTEM_NO" => $allow_point_system_no,
