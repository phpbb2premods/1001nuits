...
//-- fin mod : quick post es ---------------------------------------------------
		...
		$user_absent = ( isset( $HTTP_POST_VARS['user_absent']) ) ? intval( $HTTP_POST_VARS['user_absent'] ) : 0;
...
//-- fin mod : quick post es ---------------------------------------------------
		...
		$user_absent = $this_userdata['user_absent'];
...
//-- fin mod : quick post es ---------------------------------------------------
			...
			$s_hidden_fields .= '<input type="hidden" name="user_absent" value="' . $user_absent . '" />';			
	...
	else
	{
		...
		if( $user_absent )
		{
			$avatar = '<img src="../' . $board_config['absent_avatar'] . '" alt="" border="0" /><br />' . $lang['Absent_user_avatar_status'];
		}
