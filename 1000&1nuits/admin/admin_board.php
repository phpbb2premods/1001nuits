...
// Absent User Avatar
$new['absent_avatar'] = str_replace('"', '&quot;', strip_tags($new['absent_avatar']));
...
// Rank ProgressBar
$rank_progressbar_yes = ( $new['rank_progressbar'] ) ? 'checked="checked"' : '';
$rank_progressbar_no = ( !$new['rank_progressbar'] ) ? 'checked="checked"' : '';
$new['rank_progressbar_folder'] = str_replace('"', '&quot;', strip_tags($new['rank_progressbar_folder']));
...
// Absent User Avatar
	'L_ABSENT_AVATAR' => $lang['Absent_avatar'],
	'L_ABSENT_AVATAR_EXPLAIN' => $lang['Absent_avatar_explain'],
	'L_AVATAR_SETTINGS' => $lang['Avatar_settings'],
	'ABSENT_AVATAR' => $new['absent_avatar'],
...
// Corbeille
	'L_CORBEILLE_FORUM' => $lang['Corbeille_forum'],
	'L_CORBEILLE_FORUM_EXPLAIN' => $lang['Corbeille_forum_explain'],
	'CORBEILLE_FORUM' => $new['forum_corbeille'],
...
// Rank ProgressBar
	'L_RANK_PROGRESSBAR' => $lang['Rank_ProgressBar'],
	'L_RANK_PROGRESSBAR_FOLDER' => $lang['Rank_ProgressBar_Folder'],
	'RANK_PROGRESSBAR_YES' => $rank_progressbar_yes,
	'RANK_PROGRESSBAR_NO' => $rank_progressbar_no,
	'RANK_PROGRESSBAR_FOLDER' => $new['rank_progressbar_folder'],
