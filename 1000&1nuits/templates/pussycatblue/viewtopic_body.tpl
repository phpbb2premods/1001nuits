...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
  ...
  <tr>
	...
	<td class="row1" width="150" align="left" valign="top">
		...
		<span class="postdetails">{postrow.POSTER_RANK}<br />{postrow.RANK_IMAGE}{postrow.RANK_PROGRESSBAR}{postrow.POSTER_AVATAR}<br /><br />{postrow.POSTER_GENDER}<br />{postrow.POSTER_AGE}{postrow.POSTER_CAKE}{postrow.POSTER_FLAG}{postrow.POSTER_BROWSER}{postrow.POSTER_JOINED}<br />{postrow.POSTER_POSTS}<br />{postrow.POSTER_FROM}{postrow.POINTS}{postrow.DONATE_POINTS}<br /></span>
	</td>
...
<!-- BEGIN switch_parent_link -->
 &raquo; <a class="nav" href="{PARENT_URL}">{PARENT_NAME}</a>
<!-- END switch_parent_link -->
 &raquo; <a class="nav" href="{U_VIEW_FORUM}">{FORUM_NAME}</a></td>
