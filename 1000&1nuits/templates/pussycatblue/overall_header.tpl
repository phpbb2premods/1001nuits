	...
	<td class="bodyline"><table width="100%" cellspacing="0" cellpadding="0" border="0">
	  <tr>
		<td align="center" class="mainmenu">
			...
			&nbsp;<a href="{U_LOGIN_SEC}" class="mainmenu"><img src="templates/pussycatblue/ctracker/images/ct.gif" border="0" alt="{L_LOGIN_SEC}" hspace="3" class="absbottom" />{L_LOGIN_SEC}</a>
			<!-- END login_sec_link -->
		</td>
	  </tr>
	</table>
