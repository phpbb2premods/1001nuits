...
<table width="80%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
  ...
  <tr>
  	<td class="row3" align="right" colspan="2"><a href="{EASTER_EGG_LINK}" target="_blank"><img src="{PI_ICON}" border="0" alt="CBACK.de CrackerTracker" title="CBACK.de CrackerTracker"></a></td>
  </tr>
</table>
