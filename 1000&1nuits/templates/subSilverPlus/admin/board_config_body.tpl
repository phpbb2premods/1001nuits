...
<form action="{S_CONFIG_ACTION}" method="post">
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1" width="50%">{L_SERVER_NAME}</td>
	...
	<tr>
	  ...
	  <td class="row2"><input type="text" size="40" maxlength="255" name="reason" value="{REASON}" class="post" /></td>
	</tr>
	<tr>
	  <td class="row1">{L_ACCT_ACTIVATION}</td>
	  <td class="row2">
		<input type="radio" name="require_activation" value="{ACTIVATION_NONE}" {ACTIVATION_NONE_CHECKED} /> {L_NONE}&nbsp;
	...
	<tr>
	  ...
	  <td class="row2">
		<input type="radio" name="enable_confirm" value="1" {CONFIRM_ENABLE} /> {L_YES}&nbsp;
	...
	<tr>
	  ...
	  <td class="row2">
		<input type="radio" name="override_user_style" value="1" {OVERRIDE_STYLE_YES} /> {L_YES}&nbsp;
		<input type="radio" name="override_user_style" value="0" {OVERRIDE_STYLE_NO} /> {L_NO}
	  </td>
	</tr>
	<tr>
	...
	<tr>
	  ...
	  <td class="row2">
		<input type="radio" name="gzip_compress" value="1" {GZIP_YES} /> {L_YES}&nbsp;
...
<!-- End add - Fully integrated shoutbox MOD -->
	...
	<tr>
		<td class="row1">{L_CORBEILLE_FORUM}<br /><span class="gensmall">{L_CORBEILLE_FORUM_EXPLAIN}</span></td>
		<td class="row2"><input class="post" type="text" size="4" maxlength="4" name="forum_corbeille" value="{CORBEILLE_FORUM}" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row2"><input type="radio" name="simple_split_topic_type" value="1" {SIMPLE_SPLIT_TOPIC_TYPE_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="simple_split_topic_type" value="0" {SIMPLE_SPLIT_TOPIC_TYPE_NO} /> {L_NO}</td>
	</tr>
	<tr>
	  <td class="row1">{L_RANK_PROGRESSBAR}</td>
	  <td class="row2"><input type="radio" name="rank_progressbar" value="1" {RANK_PROGRESSBAR_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="rank_progressbar" value="0" {RANK_PROGRESSBAR_NO} /> {L_NO}</td>
	</tr>
	<tr>
		<td class="row1">{L_RANK_PROGRESSBAR_FOLDER}</td>
		<td class="row2"><input class="post" type="text" maxlength="255" name="rank_progressbar_folder" value="{RANK_PROGRESSBAR_FOLDER}" /></td>
	</tr>
  </table>
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
		<td class="row1" width="50%">{L_BDAY_REQUIRED}<br /><span class="gensmall">{L_BDAY_REQUIRED_EXPLAIN}</span></td>
		<td class="row2">
			<input type="radio" name="bday_required" value="1" {BDAY_REQUIRED_YES} /> {L_YES}&nbsp;
			<input type="radio" name="bday_required" value="0" {BDAY_REQUIRED_NO} /> {L_NO}
		</td>
	</tr>
	<tr>
		<td class="row1">{L_BDAY_GREETING}<br /><span class="gensmall">{L_BDAY_GREETING_EXPLAIN}</span></td>
		<td class="row2">
			<input type="radio" name="bday_greeting" value="1" {BDAY_GREETING_YES} /> {L_YES}&nbsp;
			<input type="radio" name="bday_greeting" value="0" {BDAY_GREETING_NO} /> {L_NO}
		</td>
	</tr>
	<tr>
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1" width="50%">{L_COOKIE_DOMAIN}</td>
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1" width="50%">{L_DISABLE_PRIVATE_MESSAGING}</td>
	  <td class="row2">
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1" width="50%">{L_MAX_POLL_OPTIONS}</td>
	...
	<tr>
	  ...
	  <td class="row2">
		<input type="radio" name="allow_sig" value="1" {SIG_YES} /> {L_YES}&nbsp;
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
		<td class="row1">{L_ABSENT_AVATAR}<br /><span class="gensmall">{L_ABSENT_AVATAR_EXPLAIN}</span></td>
		<td class="row2"><input class="post" type="text" maxlength="255" name="absent_avatar" value="{ABSENT_AVATAR}" /></td>
	</tr>
	<tr>
	...
	<tr>
	  <td class="row1">{L_MAX_AVATAR_SIZE}<br /><span class="gensmall">{L_MAX_AVATAR_SIZE_EXPLAIN}</span></td>
  ...
  <table class="forumline" width="99%" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
	  <td class="row1" width="50%">{L_COPPA_FAX}</td>
  ...
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
	  <td class="row1" width="50%">{L_ADMIN_EMAIL}</td>
