...
<form action="{S_CONFIG_ACTION}" method="post">
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr>
       <td class="row1">{L_POINT_SYSTEM}</td>
       <td class="row2"><input type="radio" name="allow_point_system" value="1" {POINT_SYSTEM_YES} /> {L_YES}&nbsp;&nbsp;<input type="radio" name="allow_point_system" value="0" {POINT_SYSTEM_NO} /> {L_NO}</td>
    </tr>
    <tr> 
