...
else if ( $mode == '2' )
{
	...
	$sql[] = "INSERT INTO " . CTRACKER_IPBLOCKER . " (`id`, `ct_blocker_value`) VALUES (23, '*Proxy*');";
...
{
	// Delte all entrys from Hashsum Checker
	$mode_selected = true;
...
{
	// Delte all entrys from CrackerTracker Filescanner
	$mode_selected = true;
